...
// import { AlertTriangle, Users, Eye, Activity, Shield } from "lucide-react"
...
//   // Get first 3 risk groups for display
//   const displayRiskGroups = disease.riskGroup?.slice(0, 3) || []
//   const hasMoreRiskGroups = disease.riskGroup?.length > 3
...
//               <CardTitle className="text-lg font-semibold text-gray-900 group-hover:text-blue-900 transition-colors line-clamp-2">
//                 {disease.name}
//               </CardTitle>
//               {disease.nameDiff && <p className="text-sm text-gray-600 mt-1 italic">Tên khác: {disease.nameDiff}</p>}
...
//             </div>
//             {disease.image && (
//               <div className="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden ml-3">
//                 <Image
...
//           {/* Description */}
//           <p className="text-sm text-gray-600 mb-4 line-clamp-3">{disease.common}</p>
...
//                 <span className="text-sm font-medium text-gray-700">Nhóm nguy cơ:</span>
//               </div>
//               <div className="flex flex-wrap gap-1">
//                 {displayRiskGroups.map((group, index) => (
...
//                     +{disease.riskGroup.length - 3} khác
//                   </Badge>
//                 )}
//               </div>
//             </div>
...
//             <Badge variant="secondary" className={`text-xs ${getStatusColor(disease.status)}`}>
...
//       <DiseaseDetail diseaseId={disease._id} isOpen={showDetail} onClose={() => setShowDetail(false)} />
//     </>
//   )
// }
"use client"
