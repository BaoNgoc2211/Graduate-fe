...
// import { Heart, AlertTriangle, Users, Stethoscope, Shield, Activity, FileText, Loader2, RefreshCw } from "lucide-react"
...
//   const { data: disease, isLoading, error, refetch } = useDiseaseById(diseaseId)
...
//     if (!symptoms || symptoms.length === 0) return "Chưa có thông tin"
...
//     if (!groups || groups.length === 0) return "Chưa có thông tin"
...
//             </div>
//             {disease?.image && (
//               <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden ml-4">
//                 <Image
...
//                   Triệu chứng
//                 </h3>
//                 <div className="flex flex-wrap gap-2">{renderSymptoms(disease.symptomIds)}</div>
//               </div>
...
//                 <div className="flex flex-wrap gap-2">{renderCategories(disease.diseaseCategoryIds)}</div>
//               </div>
...
//                 <div className="flex flex-wrap gap-2">{renderUsageGroups(disease.diseaseUsageGroupIds)}</div>
//               </div>
...
//                 <p>Ngày tạo: {new Date(disease.createdAt).toLocaleDateString("vi-VN")}</p>
//                 <p>Cập nhật: {new Date(disease.updatedAt).toLocaleDateString("vi-VN")}</p>
//               </div>
//             </div>
//           )}
//         </ScrollArea>
