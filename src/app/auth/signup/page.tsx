    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-8">
        ...
        <p className="text-center text-sm text-[#70b678] mb-6">
          Đăng ký để bắt đầu sử dụng dịch vụ của chúng tôi. Bạn có thể đăng ký
          bằng tài khoản Google hoặc email của bạn.
        </p>
        ...
        <form onSubmit={handleSignUp}>
          ...
          />
          <Button text="Đăng ký" type="submit" isLoading={mutation.isPending} />
        </form>
