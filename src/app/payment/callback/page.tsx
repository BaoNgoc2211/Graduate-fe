...
// import { checkPaymentStatusAPI } from "@/api/payment/payment.api";
...
//           try {
//             const verificationResult = await checkPaymentStatusAPI(result.orderId);
//             if (verificationResult.status !== 'success') {
//               result.status = 'failed';
//               result.message = 'Xác thực thanh toán thất bại';
//             }
//           } catch (error) {
//             console.error("Error verifying payment:", error);
//             result.status = 'pending';
//             result.message = 'Đang xác thực thanh toán...';
//           }
//         }

//         setPaymentResult(result);

//         // Clean up localStorage for successful payments
//         if (result.status === 'success') {
...
//           setMessage(`Thanh toán thất bại. Mã lỗi: ${vnpayResponseCode}`);
...
//       } else {
//         setPaymentStatus('failed');
//         setMessage('Không nhận được phản hồi từ cổng thanh toán');
//       }
...
//                       className="flex-1 bg-blue-600 hover:bg-blue-700"
//                     >
//                       {paymentStatus === 'cancelled' ? 'Thử lại thanh toán' : 'Đặt hàng lại'}
//                     </Button>
//                     <Button
//                       variant="outline"
//                       onClick={() => router.push('/cart')}
...
//       console.log("VNPay Response Code:", vnpayResponseCode);
//       console.log("MoMo Result Code:", momoResultCode);
...
//     // Add small delay to ensure all params are loaded
//     const timer = setTimeout(() => {
//       processCallback();
//     }, 100);
...
//                 <p className="text-xs">VNPay Code: {searchParams.get('vnp_ResponseCode') || 'null'}</p>
//                 <p className="text-xs">MoMo Code: {searchParams.get('resultCode') || 'null'}</p>
...
//                   <>
//                     <Button
//                       onClick={() => handleManualRedirect('/order/success')}
//                       className="flex-1 bg-green-600 hover:bg-green-700"
//                     >
//                       Xem chi tiết đơn hàng
//                     </Button>
//                     <Button
//                       variant="outline"
//                       onClick={() => handleManualRedirect('/medicine')}
//                       className="flex-1"
//                     >
//                       Tiếp tục mua sắm
//                     </Button>
...
//                   <>
//                     <Button
//                       onClick={() => handleManualRedirect('/checkout/final')}
//                       className="flex-1 bg-blue-600 hover:bg-blue-700"
//                     >
//                       {paymentStatus === 'cancelled' ? 'Thử lại thanh toán' : 'Đặt hàng lại'}
//                     </Button>
//                     <Button
//                       variant="outline"
//                       onClick={() => handleManualRedirect('/cart')}
//                       className="flex-1"
//                     >
//                       Quay lại giỏ hàng
//                     </Button>
...
// import { checkPaymentStatusAPI } from "@/api/payment/payment.api";
import { formatPrice } from "@/lib/format-price";
import { checkPaymentStatusAPI } from "@/api/payment.api";
